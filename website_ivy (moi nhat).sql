...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th4 08, 2024 lúc 04:04 PM
...
--
-- Đang đổ dữ liệu cho bảng `tbl_carta`
--
...
(67, 'admin/uploads/fb63fec93c.jfif', '1ibuv13g2ptqeurfm31iefktt4', 40, 'ÁO SƠ MI SLIM VẢI BAMBOO FIT MS 17E2977', '199000', 'admin/uploads/0fdd9af517.png', '1', 'L');
...
(63, '1ibuv13g2ptqeurfm31iefktt4', 'khachle', 'Luận', '090', '24', '218', '07498', 'dưe');
...
(45, '1ibuv13g2ptqeurfm31iefktt4', 'Giao hàng chuyển phát nhanh', 'Thu tiền tận nơi', '25/03/2024', 1);
...
(175, 41, 'Hinh123e.jfif'),
(176, 41, 'Hinh123d.jfif'),
(177, 41, 'Hinh123c.jfif'),
(178, 41, 'Hinh123b.jfif');
...
--
ALTER TABLE `tbl_carta`
  MODIFY `cartA_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=68;
...
--
ALTER TABLE `tbl_danhmuc`
  MODIFY `danhmuc_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;
...
--
ALTER TABLE `tbl_sanpham_anh`
  MODIFY `sanpham_anh_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=179;

--
-- AUTO_INCREMENT cho bảng `tbl_sanpham_size`
--
ALTER TABLE `tbl_sanpham_size`
  MODIFY `sanpham_size_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=108;
...
--
ALTER TABLE `user_info`
  ADD CONSTRAINT `user_info_ibfk_1` FOREIGN KEY (`user_id_ref`) REFERENCES `tbl_user` (`user_id`);
COMMIT;
